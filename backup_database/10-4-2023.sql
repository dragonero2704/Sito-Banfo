...
--
-- Host: 31.11.39.34
-- Creato il: Apr 10, 2023 alle 09:52
...
CREATE TABLE `articoli` (
  ...
  `titolo` varchar(69) DEFAULT NULL,
  `data` date NOT NULL,
...
(125, 'Qatar: il mondiale della vergogna', '2023-01-08', 'Sport'),
(126, 'Iran e Russia: le Rivoluzioni tradite', '2023-01-08', 'Attualità'),
(127, 'Note di un innamorato', '2023-01-11', 'Musica'),
(128, 'Limonov, il ribelle incoerente', '2023-02-02', 'Storia'),
(129, 'Rivivi il medioevo', '2023-02-17', 'Storia'),
(130, 'Il lupo della steppa', '2023-02-20', 'Libri'),
(131, 'Giuseppe Di Matteo', '2023-03-01', 'Attualità'),
(132, 'Persona 5', '2023-03-29', 'Varie'),
(133, 'Una leggenda dal Giappone', '2023-03-29', 'Varie'),
(134, 'Il soccombente di Thomas Bernhard: Riuscire a esistere', '2023-04-10', 'Libri'),
(135, 'La trasformazione pornografica dell\'Eros', '2023-04-10', 'Libri'),
(136, 'Botteghe di Tokyo', '2023-04-10', 'Libri'),
(137, 'I peluches', '2023-04-10', 'Varie'),
(138, 'Imbrattare per salvare', '2023-04-10', 'Ambiente'),
(140, 'Circe offre la coppa a Ulisse', '2023-04-10', 'Varie');
...
(67, 132, 'Scrittrice'),
(67, 136, 'Scrittrice'),
(68, 125, 'Collaboratore'),
(70, 124, 'Scrittore'),
(71, 140, 'Collaboratore'),
(72, 121, 'Scrittore'),
(72, 129, 'Scrittore'),
(73, 137, 'Scrittrice'),
(78, 133, 'Scrittrice'),
...
(71, 'Dennis', 'Calò', '1^ALC', 'Scrittore', 1),
(72, 'Edoardo', 'Rancati', '2^ALC', 'Scrittore', 1),
(73, 'Elisabetta', 'Cardinale', '3^ALC', 'Scrittrice', 1),
...
(85, 'Giacomo', 'Ferrari', '4^E', 'Membro', 1),
...
(93, 'Elisa', 'Sala', '1^ALC', 'Scrittrice', 1);
...
--
ALTER TABLE `articoli`
  MODIFY `codice_articolo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;

--
-- AUTO_INCREMENT per la tabella `redazione`
--
ALTER TABLE `redazione`
  MODIFY `codice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
