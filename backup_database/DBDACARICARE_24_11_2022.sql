...
-- Dump dei dati della tabella banfo.redazione: ~85 rows (circa)
...
INSERT INTO `redazione` (`codice`, `nome`, `cognome`, `classe`, `professione`, `attivo`) VALUES
	...
	(62, 'Riccardo', 'Germanò', '3^O', '', 1),
	(63, 'Filippo', 'De Vecchi', '5^P', 'Scrittore', 1),
	(64, 'Abdul', '', '1^P', '', 1),
	(65, 'Ada', 'Cantù', '1^A', '', 1),
	(66, 'Alice', 'Ardito', '1^ALC', '', 1),
	(67, 'Alice', 'Bacco', '1^C', 'Fotografa/Scrittrice', 1),
	(68, 'Andrea', 'Valentini', '1^ALC', '', 1),
	(69, 'Cecilia', 'Schettino', '1^N', '', 1),
	(70, 'Davide', 'Rampi', '1^ALC', 'Scrittore', 1),
	(71, 'Dennis', 'Calò', '1^ALC', '', 1),
	(72, 'Edoardo', 'Rancanti', '2^ALC', '', 1),
	(73, 'Elisabetta', '', '3^ALC', '', 1),
	(74, 'Gaia', 'Colombo', '1^N', 'Impaginatrice', 1),
	(75, 'Giacomo', 'De Mori', '2^A', '', 1),
	(76, 'Giorgia', '', '1^ALC', 'Social', 1),
	(77, 'Greta', 'Grevasoni', '2^ALC', '', 1),
	(78, 'Ilaria', 'Dall\'occhio', '4^ALC', '', 1),
	...
	(85, 'Riccardo', 'Ferrari', '4^E', '', 1),
	(86, 'Sara', 'Olivari', '5^ALC', 'Scrittrice', 1),
	(87, 'Simone', 'Villa', '2^ALC', '', 1),
	(88, 'Swetha', 'Umapathy', '1^P', '', 1),
	(89, 'Valentina', 'Bruno', '1^ALC', '', 1),
