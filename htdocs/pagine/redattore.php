  ...
  <div class="cont_menu">
    ...
    <form id="regForm" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="tab" id="bg-autore">
            <select name="autore" class="selectAutore" style="position: relative; top: 50%; transform: translate(0, -50%); border: 0; outline: none;">
                <option value="" disabled selected hidden>Autore</option>
                <?php
        ...
        <div class="tab" id="bg-autore">
            <select name="autore2" class="selectAutore" style="position: relative; top: 50%; transform: translate(0, -50%); border: 0; outline: none;">
                <option value="" disabled selected hidden>Secondo Autore</option>
                <?php
                    $sql = "SELECT codice, nome, cognome
                    FROM redazione
                    WHERE professione <> 'Programmatore'";
    ...
    <script>
        ...
        var istruzioni = ["", "Inserisci il Titolo dell'Articolo", "Inserisci la Data dell'Articolo", "Inserisci l'Argomento dell'Articolo",
                        "Inserisci l'Autore dell'Articolo","Inserisci il secondo Autore dell'Articolo (se presente)", "Inserisci il Testo dell'Articolo",
    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if( empty($_POST["titolo"]) or empty($_POST["data"]) or empty($_POST["argomento"]) or empty($_POST["autore"]) or empty($_POST["testo"]) ) {
                ...
                fclose($articolo);
                  if( empty($_POST["autore2"]) ){
                    $sql = "INSERT INTO articoli (codice_articolo, data, autore, argomento)
                            VALUES ('$codice',
                                    '".$_POST["data"]."',
                                    '".$_POST["autore"]."',
                                    '".$_POST["argomento"]."')";
                    ...
                    $sql = "INSERT INTO articoli (codice_articolo, data, autore, autore2, argomento)
                            VALUES ('$codice',
                                    '".$_POST["data"]."',
                                    '".$_POST["autore"]."',
                                    '".$_POST["autore2"]."',
