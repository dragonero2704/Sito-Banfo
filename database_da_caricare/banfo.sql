...
--
-- Host: 127.0.0.1
-- Creato il: Ott 06, 2021 alle 23:12
...
--
ALTER TABLE `articoli`
  MODIFY `codice_articolo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
ALTER TABLE `articoli`
  ...
  ADD CONSTRAINT `articoli_ibfk_1` FOREIGN KEY (`autore2`) REFERENCES `redazione` (`codice`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
